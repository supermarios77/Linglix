 ...
 * Sign In Page
 *
 * Modern, beautiful sign in page with:
...
export default async function SignInPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#fafafa] text-[#111] overflow-x-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
        <SignInForm />
      </div>
    </div>
  );
